...
<div class="container">
    ...
    <form method="POST" action="{{route('detalle.store')}}">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <select required  name="idcargo" id="idcargo" class="form-control" onclick="setmonto()">
        ...
        <div class="form-group col-12 col-lg-6">
               ...
               <div class="col-auto">
                  <input required class="form-control @error('fechains') is-invalid @enderror" type="date"
                     value=""    id="fechains" name="fechains"  />
                    @error('fechains')
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <div class="col-auto">
                    <input required class="form-control @error('monto') is-invalid @enderror" type="number"
